...
// The QMI8658 reports orient=1 when the Waveshare 1.8" AMOLED is
// held in its natural portrait orientation.
#define BASE_ORIENTATION 1
...
static const gpio_num_t PIN_LCD_CS   = GPIO_NUM_12;
static const gpio_num_t PIN_LCD_SCK  = GPIO_NUM_11;
static const gpio_num_t PIN_LCD_D0   = GPIO_NUM_4;
static const gpio_num_t PIN_LCD_D1   = GPIO_NUM_5;
static const gpio_num_t PIN_LCD_D2   = GPIO_NUM_6;
static const gpio_num_t PIN_LCD_D3   = GPIO_NUM_7;
static const gpio_num_t PIN_LCD_RST  = GPIO_NUM_13;
static const gpio_num_t PIN_TOUCH_INT = GPIO_NUM_21;
